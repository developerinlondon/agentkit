...
describe('review-gate strict evidence validation', () => {
  ...
  test('classifies every review-governance and distribution surface as critical under AgentKit policy', () => {
    ...
    for (const path of [
      ...
      'plugins-cc/agentkit-strict-review/tools/review-profile',
      'plugins-cc/agentkit-strict-review/hooks/review-police.sh',
      'plugins-cc/agentkit-strict-review/skills/adversarial-review/SKILL.md',
