...
describe('review-gate strict evidence validation', () => {
  ...
  test('classifies every review-governance and distribution surface as critical under AgentKit policy', () => {
    ...
    for (const path of [
      ...
      'plugins-cc/agentkit-review/tools/review-profile',
      'plugins-cc/agentkit-review/hooks/review-police.sh',
      'plugins-cc/agentkit-review/skills/adversarial-review/SKILL.md',
