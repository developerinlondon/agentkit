...
| `issue-police`      | filing an issue whose body does not carry a `Disposition:` line, and one whose line does not name `owner-deferred`, `owner-request`, or `blocked-by` with non-empty text — `follow-up`, `later`, `tech debt`, and similar labels are refused                                                                                                                                                                                                                                                                                                                                                                                                                                |
