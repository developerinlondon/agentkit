...
<div class="stats">
  ...
  <div class="stat"><div class="num">11</div><div class="lbl">findings fixed, 2 more recorded open</div></div>
  <div class="stat"><div class="num">45s</div><div class="lbl">bound on the git fetch and push</div></div>
  <div class="stat"><div class="num">7</div><div class="lbl">heads reviewed by two lanes</div></div>
</div>
</div>
