...
description: Judgment, not API reference — when a piece of working discipline should be a skill, a rule, a hook or a tool, and the principles that keep the kit honest.
sidebar:
  order: 1
---
...
- [Four surfaces](/docs/concepts/four-surfaces/) — the mechanics behind the ladder above.
- [Police hooks](/docs/concepts/police-hooks/) — every unit, what it checks, how to override it.
- [Cookbook](/docs/cookbook/) — the recipes these principles produce.
- [Install](/docs/getting-started/install/) — if you have not got it on a machine yet.
