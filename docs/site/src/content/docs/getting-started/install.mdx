---
title: Install
description: Get agentkit onto a machine, choose an install door, and confirm the enforcement is actually live.
sidebar:
  order: 1
---
...
- [Skill groups](/docs/getting-started/skill-groups/) — what is optional, and what the wizard
  will and will not ask.
- [What lands where](/docs/getting-started/what-lands-where/) — per-client destinations, and how
  global differs from project.
- [Requirements](/docs/getting-started/requirements/) — dependencies and platform behaviour.
