...
description: A .agentkit/product.yaml that makes your repo product-reviewable —
  built, run and used, not just read as a diff.
sidebar:
  order: 5
slug: 0.4/cookbook/declare-your-product
---
...
Why the declaration is committed rather than inferred: [The product model](/docs/0.4/concepts/product/).
