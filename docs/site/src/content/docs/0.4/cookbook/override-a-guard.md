---
title: Override a guard, once, on purpose
description: Every refusal names its legitimate exception. The exceptions are
  one-command environment variables, deliberately not config.
sidebar:
  order: 6
slug: 0.4/cookbook/override-a-guard
---
