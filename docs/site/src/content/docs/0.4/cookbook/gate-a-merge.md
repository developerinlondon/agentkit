...
description: Make a merge fail unless a review record exists for the exact
  commit the forge is about to land.
sidebar:
  order: 3
slug: 0.4/cookbook/gate-a-merge
---
...
[Review and the gate](/docs/0.4/concepts/review-and-the-gate/).
