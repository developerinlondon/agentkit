---
title: Cookbook
description: Copyable shapes for the common agentkit workflows — commands,
  files, and what you should see.
sidebar:
  order: 1
slug: 0.4/cookbook
---
...
| Recipe                                                                     | Needs                         |
| -------------------------------------------------------------------------- | ----------------------------- |
| [Publish a page](/docs/0.4/cookbook/publish-a-page/)                       | core, plus `bun`              |
| [Gate a merge on a review record](/docs/0.4/cookbook/gate-a-merge/)        | `--with strict-review`        |
| [Contain a heavy build](/docs/0.4/cookbook/contain-a-build/)               | Linux, provisioned work slice |
| [Declare what your repo ships](/docs/0.4/cookbook/declare-your-product/)   | `--with product`              |
| [Override a guard, once, on purpose](/docs/0.4/cookbook/override-a-guard/) | core                          |
