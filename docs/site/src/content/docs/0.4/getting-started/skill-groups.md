---
title: Skill groups
description: How skills are partitioned into core, product and strict-review,
  and exactly when the installer asks.
sidebar:
  order: 2
slug: 0.4/getting-started/skill-groups
---
...
[Skills](/docs/0.4/concepts/skills/).
