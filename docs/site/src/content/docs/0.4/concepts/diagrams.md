...
description: Classify the figure before drawing it, then let the register decide
  the path — and derive the graph from the source of truth where one exists.
sidebar:
  order: 8
slug: 0.4/concepts/diagrams
---
