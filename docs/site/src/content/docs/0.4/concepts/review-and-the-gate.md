...
mechanically blocks a merge. [Skill groups](/docs/0.4/getting-started/skill-groups/) covers selecting it.
:::
...
[`review-profile`](/docs/0.4/reference/cli-and-tools/) resolves how much review a change needs. Three presets: `fast` (primary review for
