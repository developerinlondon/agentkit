...
description: A committed declaration of what a product is, a reviewer that runs
  it instead of reading it, and an evidence ledger under every claim.
sidebar:
  order: 7
slug: 0.4/concepts/product
---
...
clone, and an untracked manifest is the same as no manifest at all. [Declare your product](/docs/0.4/cookbook/declare-your-product/) is the walkthrough.
...
The kit dogfoods this, declaring eight surfaces: the test suite, the Claude Code plugin, the OpenCode
