---
title: Four surfaces
description: Four kinds of discipline ordered by force — skill, rule, hook, tool
  — and why what reaches everywhere can only advise.
sidebar:
  order: 1
...
[what lands where](/docs/0.4/getting-started/what-lands-where/).
:::
