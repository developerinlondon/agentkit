...
description: The two always-loaded instruction layers, how they reach each
  client, and what agentkit does not enforce about them.
sidebar:
  order: 4
slug: 0.4/concepts/rules-and-instructions
---
...
| [Skills](/docs/0.4/concepts/skills/) | the agent invokes one      | its own trigger description | `skills/`       |
