---
title: Police hooks
description: How a guard intercepts a tool call, what refusal looks like to the
  agent, and why the exit code decides whether anyone hears it.
sidebar:
  order: 2
slug: 0.4/concepts/police-hooks
---
...
What each unit checks belongs to the [hooks reference](/docs/0.4/reference/hooks/). What follows is the
...
and config key is in [configuration](/docs/0.4/reference/configuration/); to override one guard for one
command, see [override a guard](/docs/0.4/cookbook/override-a-guard/).
