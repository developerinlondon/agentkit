---
title: FAQ
description: Answers to the things that actually go wrong, each traceable to the
  code that causes it.
sidebar:
  order: 5
slug: 0.4/reference/faq
---
...
See [Upgrading and removing](/docs/0.4/getting-started/upgrading/) for the per-file detail.
