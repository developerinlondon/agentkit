---
title: CLI and tools
description: The five executables in tools/, their flags and exit codes, and
  every AGENTKIT_ environment variable with the file that reads it.
sidebar:
  order: 3
slug: 0.4/reference/cli-and-tools
---
...
`profile`, a `context` block (risk, release, user\_facing, `target_policy_authoritative: true`,
...
[Configuration](/docs/0.4/reference/configuration/) for the keys and precedence.
