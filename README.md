...
| **issue-police.sh**    | PreToolUse               | Blocks `gh`/`glab` issue creation with no body, an unfilled template, or a `Disposition:` line that is not `owner-deferred`, `owner-request`, or `blocked-by` with non-empty text — labels like `follow-up` or `tech debt` are refused, not just an absent line                                                                                                                                                                                                                                                                                             |
