...
| Everything else structural, behavioral, data-shaped, or with a loop-back | `diagram` skill, type per its `references/selection.md` | mermaid (auto-layout destroys boundary semantics) and box kits (no backward edge) |
